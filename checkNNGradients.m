...
% Creates a small neural network to check our cost function and neural network implementation
...
% The two gradient computations are examined.  The two columns must be very similar 
disp([numgrad grad]);
fprintf(['The above two columns must be similar.\n' ...
